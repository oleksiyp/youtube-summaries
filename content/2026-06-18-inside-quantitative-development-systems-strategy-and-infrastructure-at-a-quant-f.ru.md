---
title: "Квант-разработчик изнутри: многофакторные модели, обработка данных и инфраструктура хедж-фонда"
date: "2026-06-18"
...
tags: ["количественные финансы", "торговые системы", "инженерия данных", "моделирование рисков", "распределённые вычисления", "генерация альфы"]

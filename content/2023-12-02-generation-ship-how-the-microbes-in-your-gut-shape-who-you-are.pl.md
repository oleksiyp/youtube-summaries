...
1. Zastosowano **przeszczep kału** (już praktykowany w medycynie) od młodych myszy do starych.
2. Udało się **odwrócić część procesów związanych ze starzeniem**, zwłaszcza **pogorszenie funkcji poznawczych**.
3. Mózgi starszych myszy wykazały oznaki regeneracji, a ich zdolności poznawcze się poprawiły.
4. Za dużą część efektu odpowiadała prawdopodobnie bakteria z rodzaju **Enterococcus**, licznie obecna u młodych, a nieobecna u starych myszy.
